...
<c:url var ="NewURL" value="/admin-posts"/>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<body>
		...
		<form action="<c:url value='/admin-posts'/>" id="formSubmit" method="get">
										...
										<div class="pull-right tableTools-container">
											<div class="dt-buttons btn-overlap btn-group">
												<a flag="info"
												   ...
												   title='Thêm bài viết' href='<c:url value="/admin-posts?type=edit"/>'>
															<span>
												...
												<tbody>
													<c:forEach var="item" items="${model.listResult}">
														<tr>
															...
															<td>
																<c:url var="editURL" value="/admin-posts">
